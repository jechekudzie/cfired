                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Our Journey</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                ...
                                @if($journeys)
                                    @foreach($journeys as $journey)
                                        <div class="row">
                                                            ...
                                                            <li class="list-inline-item">
                                                                <div class="d-flex align-items-center">
                                                                    <div class="flex-shrink-0 w-100">
                                                                        <a href="{{route('our-journey.edit',$journey->slug)}}"
                                                                           class="btn btn-primary">
                                                                            <i class="fa fa-pencil"></i> Edit Our Journey
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </li>
                                            ...
                                            <div class="col-xxl-4">
                                                <div class="card">
                                                    <img class="card-img-top img-fluid" src="{{asset($journey->image)}}"
                                                         alt="Card image cap">
                                                </div>
                                            </div>
                                            <!--end col-->
                            ...
                            <div class="modal fade" id="showModal" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                    <div class="modal-content border-0">
                                        ...
                                        <form method="post" action="{{route('our-journey.store')}}"
