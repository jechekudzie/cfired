            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">CFIERD - About Us</h4>
                            ...
                            <div class="card-header">
                                <div class="d-flex align-items-center flex-wrap gap-2">
                                    <div class="flex-grow-1">
                                        ...
                                        <a href="{{route('introduction.index')}}" class="btn btn-info add-btn">
                                    ...
                                    <div class="row g-0">
                                        <div style="margin-top: 15%" class="col-md-4">
                                            <img class="rounded-start w-100"
                                                 src="{{ asset($introduction->image) }}" alt="Card image">
                                        </div>
                                        <div class="col-md-8">
                                            <div class="card-header">
                                                <h5 class="card-title mb-0">{{$introduction->title}}</h5>
                                            </div>
                                            <div class="card-body">

                                                <form method="post" action="{{route('introduction.update',$introduction->slug)}}" enctype="multipart/form-data">
                                                    @method('PATCH')
                                                    @csrf
                                                    <div class="modal-body">
                                                        <div class="row g-3" style="border: 1px solid black; padding: 15px;">
                                                            <div class="col-lg-12">
                                                                ...
                                                                <input type="text" id="title" class="form-control" name="title" value="{{$introduction->title}}" placeholder="Enter title " required style="border: 2px solid black;"/>
                                                            </div>
                                                            <div class="col-lg-12">
                                                                <label for="text" class="form-label">Content</label>
                                                                <textarea name="text" class="form-control editor" id="editor" style="border: 2px solid black;">{!! $introduction->text !!}</textarea>
                                                            </div>
                                                            <div class="col-lg-6">
