...
@section('content')
    ...
    <section class="rts-breadcrumb breadcrumb-height breadcumb-bg"
             style="background-image: url(website/assets/banners/contact.png);">
        <div class="container">
            <div class="row">
                <div class="col-12">
        ...
        <div class="container">
            <div class="row">
                <div class="rts-section rt-center mb--40">
                    <h2 class="rts__section--title text-capitalize">Contact Us</h2>
                </div>
            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-10">
                        <div class="single-contact">
                            <div class="single-contact__single">
                                ...
                                <div class="method">
                                    <a href="callto:+263 242339691" class="phone">+263 242339691</a>
                                    <a href="mailto:info@c4impacteval.org"
                                       class="email-contact">info@c4impacteval.org</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="rts-page-content" style="margin-bottom: 30px; transform: none;">
        <div class="container" style="transform: none;">
            <div class="row sticky-coloum-wrap g-5 mt--45" style="transform: none;">
                <div class="col-lg-8">
                    <div class="rts-ap-section">
                        <h3 class="rts-section-title mb--30">Get In Touch</h3>
                        <div class="rts-application-form">
                            <form action="{{ route('site.contact-submit') }}" method="post">
                                ...
                                <div class="single-form-part">
                                    ...
                                    <div style="border: black" class="single-input">
                                        <div class="single-input-item">
                                            <label for="phone">Message</label>
                                            <textarea type="tel" id="phone" placeholder="Type Your Message"
                                                      rows="5"></textarea>
                                        </div>
                                    </div>
                                </div>

                                <button type="submit" class="rts-theme-btn primary with-arrow">Send
                                    Message<span><i class="fa-thin fa-arrow-right"></i></span></button>
                            </form>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 sticky-coloum-item"
                    ...
                    <div class="mt--30">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6414.931153981822!2d31.02527190300271!3d-17.794076532940203!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1931a59cd1c8f637%3A0x3cede58aa778a482!2s15%20Ridge%20Rd%2C%20Harare!5e0!3m2!1sen!2szw!4v1714722284173!5m2!1sen!2szw"
