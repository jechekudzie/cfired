...
class ContactTypeController extends Controller
{
    public function index()
    {
        ...
        return view('administration.contact_types.index', compact('contactTypes'));
    }

    public function create()
    {
        return view('administration.contact_types.create');
    }
    ...
    {
        return view('administration.contact_types.show', compact('contactType'));
    }

    public function edit(ContactType $contactType)
    {
        $contactTypes = ContactType::all();
        return view('administration.contact_types.edit', compact('contactType','contactTypes'));
    }
